    ...
    <div class="bg-white shadow rounded-lg p-6">
      <div class="grid lg:grid-cols-2 gap-6">
        ...
        >
          <div class="-mt-4 absolute tracking-wider px-1 uppercase text-xs">
            <p>
              <label for="code" class="bg-white text-gray-600 px-1"
                >Country Code *</label
              >
            </p>
          </div>
        ...
        >
          <div class="-mt-4 absolute tracking-wider px-1 uppercase text-xs">
            <p>
              <label for="status" class="bg-white text-gray-600 px-1"
...
export default {
  ...
  methods: {
    getCountry() {
      let uri =
        "https://aeocb-backend.herokuapp.com/countries/" +
        this.$route.params.id;
      this.axios.get(uri, this.country).then((response) => {
    ...
    updateCountry() {
      let uri =
        "https://aeocb-backend.herokuapp.com/countries/" +
        this.$route.params.id;
      this.axios.put(uri, this.country).then((response) => {
